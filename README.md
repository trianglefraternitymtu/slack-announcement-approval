...
Backup channel | The user who added the app to the team | Another option is to devert the post to a less important channel, this is the channel it will be deverted too.
